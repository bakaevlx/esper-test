...
@Component
/**
 * Temperature grows but RPM measurements remain constant - compromised speed sensor?
 *
 */
		
public class MultiSensorIntrusionEventListener extends BaseEventlistener  {
	...
	public void update(EventBean[] newEvents, EventBean[] oldEvents) {
		...
		sb.append("***************************************");
		sb.append("\n* [ALERT] : CRITICAL EVENT DETECTED compromised speed sensor (CRITICAL_TEMP_THRESHOLD=" + getCritTempThreshold() + ")! ");
